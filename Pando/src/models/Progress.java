...
public class Progress {
	 ...
	 */
	public void puzzle(int n){puz[n]=true;}//called when a puzzle is complete/d
	 ...
	 * 
	 */
	public int getIndex(String room){
		int n=0;
		while(n<roomEntered.length){
	...
	public boolean isPlasticTray() {
		return plasticTray;
	}
	public void setPlasticTray(boolean plasticTray) {
